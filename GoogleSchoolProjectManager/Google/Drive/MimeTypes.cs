...
namespace GoogleSchoolProjectManager.Google.Drive
{
    public static class MimeTypes
    {
        ...
        private static IDictionary<string, string> _knownGoogleTypes;

        public static IDictionary<string, string> KnownGoogleTypes
        {
            get
            {
                if (_knownGoogleTypes == null)
                {
                    _knownGoogleTypes = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase)
                    {
                        { "Audio File",             "application/vnd.google-apps.audio" },
                        ...
                        { "Photo File",             "application/vnd.google-apps.photo" },
                        ...
                        { "Video File",             "application/vnd.google-apps.video" }
                    };
                }

                return _knownGoogleTypes;
            }
        }

        public static string GoogleFolder => "application/vnd.google-apps.folder";
        public static string GoogleSpreadSheet => "application/vnd.google-apps.spreadsheet";
        public static string GoogleDocument => "application/vnd.google-apps.document";
        ...
        {
            return type1.ToLowerInvariant().Equals(type2.ToLowerInvariant());
        }
        ...
        public static string GetMimeTypeDescription(GFile googleFile)
        {
            return GetMimeTypeDescription(googleFile?.FileInfo?.MimeType);
        }
    }
}
